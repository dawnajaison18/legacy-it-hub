  ...
  insync: {
    ...
    topics:[
      { id:"portal", title:"Adding Patients to the Patient Portal",
        lead:"Give a patient access to the online InSync Patient Portal, where they can see their forms, messages, and appointments.",
        steps:[
          {text:"In InSync, open the <b>patient's chart</b> — search for the patient by name and click their record to open it.",},
          {text:"Click the <b>Demographics</b> tab — this is the page that holds the patient's basic details.",},
          {text:"Check that a valid <b>email address</b> is listed for the patient.", note:"The portal invitation is sent to this email, so if there isn't one, add it before going further."},
          {text:"Find and click the <b>Enable Portal Access</b> option, then choose the level of access the patient should have.",},
          {text:"Send the invitation, then confirm with the patient that the welcome email arrived in their inbox.",},
        ]},
      { id:"forms", title:"Sending & Managing Patient Forms",
        lead:"Send intake and assessment forms to a patient, either right away or automatically.",
        steps:[
          {text:"Open the patient's chart and go to the <b>Patient Forms</b> section.",},
          {text:"Look through the list to see which forms are available and which have already been sent.",},
          {text:"To send a form <b>right now</b>, click the form you want and choose <b>Send On-the-Fly</b>.",},
          {text:"To send forms <b>automatically</b>, attach the form to a <b>schedule</b> (sends on set dates) or to an <b>action</b> (sends when something specific happens).", note:"Double-check the timing before saving — scheduled forms send on their own without anyone clicking send."},
        ]},
      { id:"insurance", title:"Insurance Management",
        lead:"Add a patient's insurance, attach it to their record, and handle authorizations.",
        steps:[
          {text:"Go to the <b>Insurance</b> section to add a new insurance company or edit one that already exists.",},
          {text:"Attach the insurance to the patient, and set whether it's their <b>primary</b> (main) or <b>secondary</b> (backup) insurance.",},
          {text:"Where required, enter the <b>authorization</b> details — the number of approved visits (units) and the start and end dates.",},
          {text:"When an insurance is no longer used, <b>inactivate</b> it instead of deleting it.", note:"Deleting removes the billing history — always inactivate so the records are kept."},
        ]},
      { id:"provider", title:"Adding a Provider",
        lead:"Create a record for a new provider (doctor, therapist, and so on) and give them the right access.",
        steps:[
          {text:"Go to <b>Admin → Providers</b> and click <b>Add Provider</b>.",},
          {text:"Fill in the provider's details, including their <b>NPI number</b> (their official healthcare ID) and credentials.",},
